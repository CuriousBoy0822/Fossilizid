...
private:
	...
	typedef Fossilizid::container::detail::_hazard_ptr<_que_node> _hazard_node_ptr;
	typedef Fossilizid::container::detail::_hazard_system<_que_node> _hazard_node_system;
	typedef Fossilizid::container::detail::_hazard_ptr<_list> _hazard_list_ptr;
	typedef Fossilizid::container::detail::_hazard_system<_list> _hazard_list_system;
